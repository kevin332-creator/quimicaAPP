...
function Dashboard() {
  ...
  useEffect(() => {
    // Carga dinámica de los scripts necesarios (si no están en el bundle principal)
      ...
      {/* Sección para estudiantes */}
        ...
        <div className="mb-4" style={{ 
          ...
          padding: '16px',
            ...
            {/*Seccion de tabal periodica*/}
            <div className='mt-4'>
            <div className="d-flex justify-content-between align-items-center mb-3">
            </div>
            <div className='bg-gray-100'>
              {/* Usa las etiquetas de los Web Components */}
        ...
        <div className="modal-dialog modal-lg">
          <div className="modal-content">
            <div className="modal-header d-flex justify-content-between" style={{   
              ...
              <h5 className="modal-title"> <span style={{ 
                color: 'black',
                fontweight: 'bolder',
                fontfamily: 'monospace', 
              }}>Detalles del Elemento:</span>  <strong>{elementoDetalle.name}</strong> </h5>
              <button type="button" className="btn btn-danger" onClick={closeDetalle}>
                Cerrar
              </button>
            </div>
            <div className="modal-body">
              <h2 className="text-2xl text-center font-bold text-blue-800">{elementoDetalle.symbol} - {elementoDetalle.name}</h2>
              <div>
                <p className="font-semibold"><strong>Descripción:</strong>  <span className="font-bold">{elementoDetalle.description}</span> </p>
              </div>
              <div className="row">
                {/* Primera tabla */}
